...
public class Crop {
    ...
    public void start(Activity activity, String leftButtonText, String rightButtonText) {
        activity.startActivityForResult(getIntent(activity, leftButtonText.toUpperCase(), rightButtonText.toUpperCase()), REQUEST_CROP);
    }
    ...
    public Intent getIntent(Context context, String leftButtonText, String rightButtonText) {
        cropIntent.putExtra("LEFT_BUTTON_TEXT",leftButtonText);
        cropIntent.putExtra("RIGHT_BUTTON_TEXT", rightButtonText);
        cropIntent.setClass(context, CropImageActivity.class);
        return cropIntent;
    }

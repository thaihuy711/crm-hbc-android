...
class
WorkAdapter(internal var mContext: Context, internal var mData: List<EventItem>) : RecyclerView.Adapter<WorkAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //            }
        //        });
        holder.icPhone.setVisibility(View.GONE)
...
//        public var menuGroup: View
        ...
        public lateinit var icPhone: LinearLayout
...
//            menuGroup = view.findViewById(R.id.menu_group)
            ...
            icPhone = view.findViewById(R.id.icPhone)
